...
const About = () => {
  return (
    <Container>
      {/* grid */}
      <div className="grid grid-cols-2 gap-8 my-30">
          ...
          <div className="grid grid-cols-2 gap-8">
            ...
            <GlowWrapper>
              <div className="flex items-center space-x-5 min-h-[70px]">
                <p className="bg-indigo-600 p-3 rounded-full text-xl"><FaCode /></p>
            ...
            <div className="bg-indigo-600 px-3 py-4 rounded-full text-center">
              <button className="h1 text-xl text-white font-semibold cursor-pointer">Read More About Me →</button>
            </div>
      ...
      <div className="grid grid-cols-4 gap-8">
        ...
        <GlowWrapper>
          <div className="text-center flex flex-col space-y-1 py-2">
            <h1 className="text-5xl font-bold">20 K+</h1>
            <p className="text-white/50 text-lg">Our Project Complete</p>
          </div>
        </GlowWrapper>

        <GlowWrapper>
          <div className="text-center flex flex-col space-y-1  py-2">
            <h1 className="text-5xl font-bold">10 K+</h1>
            <p className="text-white/50 text-lg">Our Natural Products</p>
          </div>
        </GlowWrapper>
        ...
        <GlowWrapper>
          <div className="text-center flex flex-col space-y-1 py-2">
            ...
            <p className="text-white/50 text-lg">Clients Reviews</p>
          </div>
        </GlowWrapper>

        <GlowWrapper>
          <div className="text-center flex flex-col space-y-1 py-2">
            <h1 className="text-5xl font-bold">1,000 +</h1>
            <p className="text-white/50 text-lg">our Satisfied Clientd</p>
          </div>
        </GlowWrapper>
